...
public:
  Teleop()
  {
    ...
    land_publisher_ = node_handle_.advertise<std_msgs::Empty>("land", 1);
    takeoff_publisher_ = node_handle_.advertise<std_msgs::Empty>("takeoff", 1);
    reset_publisher_ = node_handle_.advertise<std_msgs::Empty>("reset",1);
  }
